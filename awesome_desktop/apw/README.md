It's a fork of [mokasin/apw](https://github.com/mokasin/apw) widget adapted to work with Awesome WM 4.0

Next it comes the readme from original project, i hope it's still up-to-date.
...
git clone https://github.com/actionless/apw.git
```
